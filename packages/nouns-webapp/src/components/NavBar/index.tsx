...
import logo from '../../assets/noundry-logo.svg';
    ...
    <>
      ...
      >
        <Container style={{ maxWidth: 'unset' }}>
          <div className={classes.simpleBrandAndTreasuryWrapper}>
            {/* Left-aligned logo */}
            {/* <Navbar.Brand as={Link} to="/" className={classes.navBarBrand}>
              <img src={logo} className={classes.navBarLogo} alt="Nouns DAO logo" />
            </Navbar.Brand> */}
            <Navbar.Brand as={Link} to="/" className={classes.navBarSimpleBrand}>
              <img src={logo} className={classes.navBarSimpleLogo} alt="Noundry logo" />
              <p>Season 0 coming soon</p>
            </Navbar.Brand>
            {Number(CHAIN_ID) !== 1 && (
              <Nav.Item>
